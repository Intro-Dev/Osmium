...
import dev.lobstershack.client.config.options.OptionDeserializer;
import dev.lobstershack.client.config.options.OptionSerializer;
import dev.lobstershack.client.config.options.legacy.LegacyOption;
import dev.lobstershack.client.config.options.legacy.LegacyOptionDeserializer;
import dev.lobstershack.client.config.options.legacy.LegacyOptionSerializer;
...
public class Options {
    ...
    public static final Option<dev.lobstershack.client.config.options.SneakMode> SneakMode = new Option<>("HurtBobbingEnabled", dev.lobstershack.client.config.options.SneakMode.VANILLA);
    ...
    public static final Option<dev.lobstershack.client.config.options.BlockOutlineMode> BlockOutlineMode = new Option<>("CustomBlockOutline", dev.lobstershack.client.config.options.BlockOutlineMode.VANILLA);
    ...
    public static final Option<dev.lobstershack.client.config.options.StatusEffectDisplayMode> StatusEffectDisplayMode = new Option<>("StatusEffectDisplayMode", dev.lobstershack.client.config.options.StatusEffectDisplayMode.VANILLA);
    ...
    public static final Option<dev.lobstershack.client.config.options.LevelHeadMode> LevelHeadMode = new Option<>("LevelHeadMode", dev.lobstershack.client.config.options.LevelHeadMode.NETWORK_LEVEL);
    ...
    public static void loadConfig(String path) {
        try {
            ...
            try {
                ...
                arr = DataFixer.fixLegacyOptions(GSON.fromJson(builder.toString().replaceAll("com.Intro", "dev.lobstershack"), LegacyOption[].class));
            }
            if(arr.length != 0) {
                for(Option<?> o : arr)  {
                    if(o == null) {
                        LOGGER.warn("Tried to load a null option, skipping");
                    }
                    try {
    ...
    public static void saveConfig(String path) {
        try {
            ...
            writer.close();
            DebugUtil.logIfDebug("Saved config to file " + path, Level.INFO);
        } catch (Exception e) {

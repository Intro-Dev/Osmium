...
public class Options {
    ...
    public static final Option<dev.lobstershack.common.config.options.SneakMode> SneakMode = new Option<>("HurtBobbingEnabled", dev.lobstershack.common.config.options.SneakMode.VANILLA);
    ...
    public static final Option<dev.lobstershack.common.config.options.BlockOutlineMode> BlockOutlineMode = new Option<>("CustomBlockOutline", dev.lobstershack.common.config.options.BlockOutlineMode.VANILLA);
    ...
    public static final Option<dev.lobstershack.common.config.options.StatusEffectDisplayMode> StatusEffectDisplayMode = new Option<>("StatusEffectDisplayMode", dev.lobstershack.common.config.options.StatusEffectDisplayMode.VANILLA);
    ...
    public static final Option<dev.lobstershack.common.config.options.LevelHeadMode> LevelHeadMode = new Option<>("LevelHeadMode", dev.lobstershack.common.config.options.LevelHeadMode.NETWORK_LEVEL);

...
public class OsmiumBlockOptionsScreen extends Screen {
    ...
    protected void init() {
        ...
        AlphaSelectWidget = new DoubleSliderWidget(mc,this.width / 2 - 175, this.height / 6 + 60, 150, 20, Osmium.options.getDoubleOption(Osmium.options.BlockOutlineAlpha.identifier),"osmium.options.blockoverlayalpha", 0, 255);

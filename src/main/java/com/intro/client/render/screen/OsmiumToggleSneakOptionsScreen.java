...
public class OsmiumToggleSneakOptionsScreen extends Screen {
    ...
    protected void init() {
        ...
        DoubleSliderWidget flyBoostAmountWidget = new DoubleSliderWidget(mc, this.width / 2 + 25, this.height / 6 + 60, 150, 20, ((DoubleOption) OsmiumClient.options.get(OsmiumClient.options.FlyBoostAmount.identifier)), "osmium.options.flyboostamount", 0, 10, 10);
